...
See [`ci/github/workflows/deploy-aws-prod.yml`](../ci/github/workflows/deploy-aws-prod.yml)
...
See [`ci/gitlab/.gitlab-ci.yml`](../ci/gitlab/.gitlab-ci.yml)
...
See [`ci/azure-devops/azure-pipelines.yml`](../ci/azure-devops/azure-pipelines.yml)
...
See [`infra/aws/main.tf`](../infra/aws/main.tf)
...
See [`infra/azure/main.tf`](../infra/azure/main.tf) and [`ci/github/workflows/deploy-azure-prod.yml`](../ci/github/workflows/deploy-azure-prod.yml)
...
See [`security/trivy-policy.yml`](../security/trivy-policy.yml)
...
See [`ci/github/workflows/pr-checks.yml`](../ci/github/workflows/pr-checks.yml)
...
See [`ci/github/workflows/deploy-azure-prod.yml`](../ci/github/workflows/deploy-azure-prod.yml)
...
See [`ci/github/workflows/deploy-azure-prod.yml`](../ci/github/workflows/deploy-azure-prod.yml) and [`ci/gitlab/.gitlab-ci.yml`](../ci/gitlab/.gitlab-ci.yml) for Azure and GitLab examples.
...
### CI/CD Workflows
- **GitHub Actions (AWS)**: [`ci/github/workflows/deploy-aws-prod.yml`](../ci/github/workflows/deploy-aws-prod.yml)
- **GitHub Actions (Azure)**: [`ci/github/workflows/deploy-azure-prod.yml`](../ci/github/workflows/deploy-azure-prod.yml)
- **GitHub Actions (PR Checks)**: [`ci/github/workflows/pr-checks.yml`](../ci/github/workflows/pr-checks.yml)
- **GitLab CI**: [`ci/gitlab/.gitlab-ci.yml`](../ci/gitlab/.gitlab-ci.yml)
- **Azure DevOps**: [`ci/azure-devops/azure-pipelines.yml`](../ci/azure-devops/azure-pipelines.yml)

### Infrastructure as Code
- **AWS (OIDC + ECR)**: [`infra/aws/main.tf`](../infra/aws/main.tf)
- **Azure (ACR)**: [`infra/azure/main.tf`](../infra/azure/main.tf)

### Security Configuration
- **Trivy Policy**: [`security/trivy-policy.yml`](../security/trivy-policy.yml)
- **CodeQL Config**: [`security/codeql-config.yml`](../security/codeql-config.yml)

### Application
- **Dockerfile**: [`app/Dockerfile`](../app/Dockerfile)
- **Python App**: [`app/main.py`](../app/main.py)
