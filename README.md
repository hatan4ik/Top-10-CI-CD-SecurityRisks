...
#### GitHub Actions
- [AWS Production Deployment](ci/github/workflows/deploy-aws-prod.yml) - OIDC auth, ECR, cosign signing
- [Azure Production Deployment](ci/github/workflows/deploy-azure-prod.yml) - Federated credentials, ACR
- [PR Security Checks](ci/github/workflows/pr-checks.yml) - Read-only, no secrets
